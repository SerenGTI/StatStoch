...
\paragraph{Beispiel:}
Sei $X\sim\binomial(n=50,p)$ und es liegt eine Stichprobe mit $k=X(\omega)=30$ vor. Wir möchten nun zur Unsicherheit $\alpha=2\beta=0.1$, d.h. mit $90\%$-iger Sicherheit angeben, in welchem Intervall sich $p$ befindet.
